...
- [ ] 7.3 Verify skill loads via `GET /api/skills` — should show `skill-manager` as enabled (note: full functionality requires `exec-runtime-overhaul` for mount-aware access to `data/skills/` and managed-skill discovery)
