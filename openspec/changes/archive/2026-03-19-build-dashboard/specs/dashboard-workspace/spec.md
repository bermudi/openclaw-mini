...
Inline workspace file browser and editor for the dashboard, allowing operators to view, edit, and create workspace files (`IDENTITY.md`, `SOUL.md`, etc.) without leaving the dashboard.
